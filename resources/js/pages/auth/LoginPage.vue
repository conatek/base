            ...
            <div class="login-card">
                ...
                <form @submit.prevent="handleLogin">
                    ...
                    <div class="text-center d-flex flex-column gap-3">
                        <router-link to="/" class="btn-link-custom">
            ...
            try {
                ...
                if (error.response) {
                    if (error.response.status === 422) {
                        ...
                        this.generalError = 'La sesión ha expirado. Recarga la página e intenta de nuevo.';
                    } else {
                        this.generalError = 'Error al iniciar sesión. Intenta de nuevo.';
                    }
                } else {
                    this.generalError = 'Error de conexión.';
                }
            } finally {
                this.loading = false;
            }
