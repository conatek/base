    ...
    <div>
            ...
            <div v-if="collaborators && collaborators.length > 0" class="row">
                <div class="col-sm-12 col-lg-4">
                    <div class="input-group mb-3">
                        ...
                        <input v-model="search" @input="handleSearch" placeholder="Buscar (Nombre, Doc, Email)..."
                ...
                <div v-for="collaborator in paginatedData" :key="collaborator.id"
                    ...
                    <div class="card-profile mb-3">
                        <div class="img-avatar">
                            ...
                            <img v-else :src="'/images/default-profile.jpeg'"
                                :alt="collaborator ? collaborator.name : 'Default profile'">
                        </div>
                            ...
                            <div class="title-total">
                                <div v-if="collaborator && collaborator.isProfileComplete" class="title d-flex justify-content-end align-items-center">
                                    ...
                                    <span v-if="collaborator && collaborator.is_active == 1"
                                        ...
                                        class="badge rounded-pill bg-success" style="cursor: pointer;">
                                        Activo
                                    </span>
                                ...
                                <div>
                                    ...
                                    <div class="surname-profile text-truncate"
                                        style="border-bottom: 1px dotted #127cb3; padding-bottom: 10px; margin-bottom: 10px;">
                                        {{
                                            collaborator ? collaborator.first_surname : '' }} {{ collaborator ?
                                        collaborator.second_surname : '' }}</div>
                                </div>

                                <div>
                                    <div class="cellphone-profile text-truncate">{{ collaborator &&
                                        collaborator.position ?
                                        collaborator.position.name : 'Cargo sin definir' }}</div>
                                    <div class="email-profile text-truncate">{{ collaborator ? collaborator.email : ''
                                        }}</div>
                                </div>
        ...
        <div v-else-if="viewState === 'detail' && collaboratorData">
            <collaborator-show @editCollaborator="editCollaborator" :collaborator="selected_collaborator"
                :document_type="collaboratorData.document_type" :document_province="collaboratorData.document_province"
                :document_city="collaboratorData.document_city" :birth_province="collaboratorData.birth_province"
                :birth_city="collaboratorData.birth_city" :residence_province="collaboratorData.residence_province"
                :residence_city="collaboratorData.residence_city" :civil_status="collaboratorData.civil_status"
                :sex_type="collaboratorData.sex_type" :rh_type="collaboratorData.rh_type"
                :stratum_type="collaboratorData.stratum_type"
                :highest_academic_achievement="collaboratorData.highest_academic_achievement"
                :housing_tenure="collaboratorData.housing_tenure" :staff_provider="collaboratorData.staff_provider"
                :relationship_types="collaboratorData.relationship_types"
                :occupation_types="collaboratorData.occupation_types" :sex_types="collaboratorData.sex_types"
                ...
                :contractual_documents_types="collaboratorData.contractual_documents_types"></collaborator-show>
        </div>
        <div v-else-if="viewState === 'add' && selectsDataCreate">
            <collaborator-create :document_types="selectsDataCreate.document_types"
        ...
        <div v-else-if="viewState === 'edit' && collaboratorDataEdit">
            <collaborator-edit :collaborator="selected_collaborator"
                :document_types="collaboratorDataEdit.document_types" :sex_types="collaboratorDataEdit.sex_types"
                :civil_status_types="collaboratorDataEdit.civil_status_types" :rh_types="collaboratorDataEdit.rh_types"
        ...
        <div v-else-if="viewState === 'absence'">
            <collaborator-absence :collaborator="selected_collaborator" :absence_types="absence_types"
                :absence_subtypes="absence_subtypes"></collaborator-absence>
        </div>
        <div v-else-if="viewState === 'contract'">
            <collaborator-contract :collaborator="selected_collaborator"></collaborator-contract>
        </div>
        <div v-else-if="viewState === 'social'">
            <collaborator-social-security :collaborator="selected_collaborator"></collaborator-social-security>
        </div>
    </div>
</template>
